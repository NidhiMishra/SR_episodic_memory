...
if __name__=="__main__":
    ...
    # inputs=['sentence=venessa baby', 'subject=Unknown', 'emotion=None 0.5', 'mood= 0.5', 'eventState=Present', 'user=Unknown', 'weekday=Thu', 'socialTime=Afternoon']
    # em_handler.getPeerEvent(inputs,None,"user=UnKnown")
    # em_handler.getGreetings("user=Nadia")
